...
tmpfile = "/home/thomas.callister/RedshiftDistributions/BBH-spin-q-correlations/code/dynesty_output/dynesty_results_noEvol_job{0}.resume".format(job)
if os.path.isfile(tmpfile):
    ...
    sampler = dynesty.NestedSampler(logp_powerLawPeak_noEvol, priorTransform_powerLawPeak_noEvol, 9,
...
res = sampler.results
np.save('/home/thomas.callister/RedshiftDistributions/BBH-spin-q-correlations/code/dynesty_output/dynesty_results_noEvol_job{0}'.format(job),res)

#sampler.run_nested(dlogz=0.1)
#res = sampler.results
#np.save('/home/thomas.callister/RedshiftDistributions/BBH-spin-q-correlations/code/dynesty_output/dynesty_results_noEvol_n8000',res)
