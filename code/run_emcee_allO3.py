...
# Dicts with samples: 
sampleDict = np.load("/home/thomas.callister/RedshiftDistributions/spin-evolution/input/sampleDict_O3_FAR_1_in_10.pickle")
sampleDict.pop('S200115j')
sampleDict.pop('S200105ae')
...
mockDetections = h5py.File('/home/thomas.callister/CBC/O3b-preliminary-studies/vts_injection_o3all_scaled_from_o3a_bbhpop_inj_info.hdf','r')
...
detected = (ifar_1>10) + (ifar_2>10) + (ifar_3>10)
...
if __name__=="__main__":
    ...
    nWalkers = 32
    output = "/home/thomas.callister/RedshiftDistributions/spin-evolution/code/spin_with_q/emcee_samples_qDependence_O3_FAR_1_per_10"
