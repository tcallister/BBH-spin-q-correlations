...
nWalkers = 32
output = "/home/thomas.callister/RedshiftDistributions/BBH-spin-q-correlations/code/output/emcee_samples_plPeak_variableChiMin"
...
if len(old_chains)==0:
    ...
    initial_chi_mins = np.random.random(nWalkers)*0.1-0.3
    initial_walkers = np.transpose([initial_lmbdas,initial_mMaxs,initial_m0s,initial_sigMs,initial_fs,initial_bqs,initial_ks,initial_mu0s,initial_sigma0s,initial_alphas,initial_betas,initial_chi_mins])
...
# Run
nSteps = 40000
sampler = mc.EnsembleSampler(nWalkers,dim,logp_powerLawPeak_variableChiMin,args=[sampleDict,injectionDict,priorDict],threads=16)
