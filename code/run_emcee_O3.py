...
# Dicts with samples: 
sampleDictFull = np.load("/home/thomas.callister/RedshiftDistributions/spin-evolution/input/sampleDict_analyticPrior.pickle")
sampleDict = {}
for key in sampleDictFull:
    if key[0]=="S":
        sampleDict[key] = sampleDictFull[key]
...
if __name__=="__main__":
    ...
    nWalkers = 32
    output = "/home/thomas.callister/RedshiftDistributions/spin-evolution/code/spin_with_q/emcee_samples_qDependence_O3only"
