...
# Dicts with samples: 
sampleDict = np.load("/home/thomas.callister/RedshiftDistributions/spin-evolution/input/sampleDict_w190814.pickle")
...
if __name__=="__main__":
    ...
    nWalkers = 32
    output = "/home/thomas.callister/RedshiftDistributions/spin-evolution/code/spin_with_q/emcee_samples_qDependence_w190814"
    ...
    # Run
    nSteps = 10000
    sampler = mc.EnsembleSampler(nWalkers,dim,logposterior,threads=2)
