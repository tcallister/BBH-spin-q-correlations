...
for event in sampleDict:
    offset = np.random.normal(loc=0,scale=0.3)
    sampleDict[event]['Xeff'] = sampleDict[event]['Xeff'] + offset
...
if __name__=="__main__":
    ...
    nWalkers = 32
    output = "/home/thomas.callister/RedshiftDistributions/spin-evolution/code/spin_with_q/emcee_samples_qDependence_chiScramble"
