...
tmpfile = "/home/thomas.callister/RedshiftDistributions/BBH-spin-q-correlations/code/dynesty_output/dynesty_results_noNeg_job{0}.resume".format(job)
if os.path.isfile(tmpfile):
    ...
    sampler = dynesty.NestedSampler(logp_powerLawPeak_noNeg, priorTransform_powerLawPeak, 11, 
...
res = sampler.results
np.save('/home/thomas.callister/RedshiftDistributions/BBH-spin-q-correlations/code/dynesty_output/dynesty_results_noNeg_job{0}'.format(job),res)
...
sampler = dynesty.NestedSampler(logp_powerLawPeak_noNeg, priorTransform_powerLawPeak, 11, 
                nlive = 8000, ptform_args=[priorDict], logl_args=[sampleDict,injectionDict,priorDict],
                sample='unif',
                pool = Pool(16), queue_size=16, bound='multi', first_update={'min_eff':10,'min_ncall':10000})

sampler.run_nested(dlogz=0.1)
res = sampler.results
np.save('/home/thomas.callister/RedshiftDistributions/BBH-spin-q-correlations/code/dynesty_output/dynesty_results_noNeg_n8000',res)
"""
