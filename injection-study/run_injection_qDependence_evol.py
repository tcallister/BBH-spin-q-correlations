...
def logposterior(c):
    ...
    if lmbda1<lmbda1_min or lmbda1>lmbda1_max or lmbda2<lmbda2_min or lmbda2>lmbda2_max or m0<m0_min or m0>m0_max or bq<bq_min or bq>bq_max or mu0<mu_min or mu0>mu_max or log_sigma0<log_sigma_min or log_sigma0>log_sigma_max or alpha<alpha_min or alpha>alpha_max or beta<beta_min or beta>beta_max:
        return -np.inf
...
if __name__=="__main__":
    ...
    nWalkers = 32
    output = "/home/thomas.callister/RedshiftDistributions/spin-evolution/code/injections/emcee_samples_injection_qDependence_evol"
